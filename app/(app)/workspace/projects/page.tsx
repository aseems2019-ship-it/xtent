  ...
  const filteredProjects = useMemo(() => {
    return projects.filter((project) => {
      ...
      const matchesSearch =
        ...
        project.type.toLowerCase().includes(text);
      ...
      <div className="mx-auto max-w-7xl">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-gray-800 bg-[#10131d] p-12 text-center">
            ...
            <button
              onClick={() => setShowCreate(true)}
              className="mt-6 rounded-xl bg-cyan-400 px-6 py-3 font-semibold text-black hover:bg-cyan-300"
            >
              Create Project
            </button>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            ...
            {filteredProjects.map((project) => (
              ...
              <div
                key={project.id}
                className="rounded-2xl border border-gray-800 bg-[#10131d] transition hover:-translate-y-1 hover:border-cyan-400/50"
              >
